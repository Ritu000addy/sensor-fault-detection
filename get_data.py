#file_path = "D:\project\sfd\sensor-fault-detection\aps_failure_training_set1.csv"
...
#    data_file_path = "D:\project\sfd\sensor-fault-detection\aps_failure_training_set1.csv"
