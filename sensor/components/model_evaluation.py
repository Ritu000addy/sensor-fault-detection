...
from sensor.entity.artifact_entity import DataValidationArtifact, ModelTrainerArtifact, ModelEvaluationArtifact #output
    ...
    def initiate_model_evaluation(self)->ModelEvaluationArtifact:
        try:
            ...
            if not model_resolver.is_model_exists():
                ...
                write_yaml_file(self.model_eval_config.report_file_path, model_evaluation_artifact.__dict__)
            ...
            improved_accuracy = trained_metric.f1.score - latest_metric.f1_score
