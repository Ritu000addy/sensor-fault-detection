...
from sensor.entity.artifact_entity import DataValidationArtifact, ModelTrainerArtifact, ModelEvaulationArtifact #output
...
class ModelEvaluation:
    ...
    def initiate_data_evaluation(self)->ModelEvaulationArtifact:
        try:
            ...
            if not model_resolver.is_model_exists():
                model_evaluation_artifact =  ModelEvaulationArtifact(
