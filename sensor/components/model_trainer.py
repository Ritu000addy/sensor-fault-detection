...
from sensor.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact #output
    ...
    def initiate_model_trainer(self)-> ModelTrainerArtifact:
        try:
            ...
            x_train, y_train, x_test, y_test = (
                train_arr[:, :-1],  #before the last column
                train_arr[:, -1],   #only the last column
                test_arr[:, :-1],
                test_arr[:, -1],
            )
